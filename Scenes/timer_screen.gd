...
func _ready() -> void:
	...
	if Global.minigames_done < 3: # if you havent completed 3 minigames yet 
		...
		get_tree().change_scene_to_file("res://Scenes/minigame_2.tscn") # changes your scene by arranging this frankenstein path. 
...
# should be next. Make sure you name your minigame saves appropriately.
		...
		get_tree().change_scene_to_file("res://Scenes/level_screen.tscn") # changes your scene
